...
const dancing_script = Dancing_Script({ subsets: ["latin"], weight: "700", display: "swap", variable: "--font-dancing-script" });
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${poppins.variable} ${dancing_script.variable} ${bebas_neue.variable} bg-main-background-100`}>
        <Header />
